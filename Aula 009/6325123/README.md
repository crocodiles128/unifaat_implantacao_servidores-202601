...
Obter a URL do Service:

```bash
minikube service web-service-tf09 --url
```

Testar com `curl`, usando a URL retornada pelo comando anterior:

```bash
curl http://URL_RETORNADA_PELO_MINIKUBE
```

Escalar o Deployment para 5 replicas:
